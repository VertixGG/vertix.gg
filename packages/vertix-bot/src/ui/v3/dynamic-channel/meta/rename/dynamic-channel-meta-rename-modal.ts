...
import { DynamicChannelMetaRenameInput } from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/rename/dynamic-channel-meta-rename-input";

export class DynamicChannelMetaRenameModal extends UIModalBase {
    public static getName() {
        return "Vertix/UI-V3/DynamicChannelMetaRenameModal";
    }
