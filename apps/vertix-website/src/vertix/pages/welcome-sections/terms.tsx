export default function Terms() {
    return (
        <div className="mb-12">
            <h2 id="terms" className="text-h4 mb-6">Getting to Know the Basics</h2>
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="col-span-12 md:col-span-6">
                        <div className="p-6 rounded-2xl bg-vc-space border border-vc-hairline-bright h-full">
                            <h3 className="text-h5 text-vc-azure-soft mb-4"><strong>Master Channel</strong></h3>
                            <p className="mb-0">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <div className="p-6 rounded-2xl bg-vc-space border border-vc-hairline-bright h-full">
                            <h3 className="text-h5 text-vc-mint mb-4"><strong>Dynamic Channel</strong></h3>
                            <p className="mb-0">
