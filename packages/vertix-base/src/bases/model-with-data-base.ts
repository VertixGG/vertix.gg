...
> extends ModelBaseCachedWithModel<TOwnerModel, TOwnerModelResult> {
    ...
    protected constructor() {
        ...
        function WrapperMixin<T extends AbstractConstructor<ModelDataOwnerBase<TOwnerModel, TDataModel, TDataModelResult, TDataModelUniqueKeys>>>( Ctor: T ) {
            abstract class ModelDataOwnerWrapper extends Ctor {
                ...
                public async getData<T extends TDataType>( keys: TWithOptionalProps<TDataModelUniqueKeys, "version">, options: {
                    cache: boolean,
                } ) {
    ...
    protected abstract getDataModels(): ( new () => ModelDataOwnerBase<TOwnerModel, TDataModel, TDataModelResult, TDataModelUniqueKeys> )[];
}
