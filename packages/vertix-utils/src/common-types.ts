 ...
 */
export type TRecursiveStringMapper<T extends readonly string[], U extends readonly string[]> = Omit<
    // Omit is used to exclude certain properties from a type, here we exclude 'never'
