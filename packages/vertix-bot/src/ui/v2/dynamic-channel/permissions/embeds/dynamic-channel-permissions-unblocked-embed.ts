...
const DynamicChannelPermissionsUnblockedEmbed = new EmbedBuilder<UIArgs, typeof vars>(
    ...
    .setDescription( () => (
        `**${ vars.userUnBlockedDisplayName }** successfully un-blocked!\n\n` +
