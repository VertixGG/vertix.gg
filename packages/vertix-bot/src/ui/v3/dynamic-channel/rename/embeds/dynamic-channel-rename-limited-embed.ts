...
export class DynamicChannelRenameLimitedEmbed extends UIEmbedElapsedTimeBase {
    private static vars = {
    ...
    protected getOptions() {
        ...
        } = DynamicChannelRenameLimitedEmbed.vars;
    ...
    protected getLogic( args: UIArgs ) {
        ...
        if ( args.masterChannelId ) {
            ...
            result.masterChannelMessage = DynamicChannelRenameLimitedEmbed.vars.masterChannelId;
        } else {
            result.masterChannelMessage = DynamicChannelRenameLimitedEmbed.vars.masterChannelMessageDefault;
        }
