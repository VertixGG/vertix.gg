...
describe( "VertixGUI/UIService", () => {
    ...
    describe( "generateCustomIdHash", () => {
        ...
        it( "should overcome scenario when parts are already hashed1", () => {
            // Arrange
            uiService.generateCustomIdHash( "VertixGUI/SetupAdapter:VertixGUI/SetupMasterEditButton" );
        ...
        it( "should overcome scenario when parts are already hashed2", () => {
            // Arrange
            uiService.generateCustomIdHash( "VertixGUI/SetupAdapter" );
            uiService.generateCustomIdHash( "VertixGUI/SetupMasterEditButton" );
