...
import { SetupEmbed } from "@vertix.gg/bot/src/ui/v3/setup/setup-embed";
import { SetupElementsGroup } from "@vertix.gg/bot/src/ui/v3/setup/setup-elements-group";
import { SetupMaxMasterChannelsEmbed } from "@vertix.gg/bot/src/ui/v3/setup/setup-max-master-channels-embed";
import { BadwordsModal } from "@vertix.gg/bot/src/ui/v3/badwords/badwords-modal";

export class SetupComponent extends UIComponentBase {
    public static getName() {
        return "Vertix/UI-V3/SetupComponent";
    }
    ...
    protected static getDefaultElementsGroup() {
        return "Vertix/UI-V3/SetupElementsGroup";
    }

    protected static getDefaultEmbedsGroup() {
        return "Vertix/UI-V3/SetupEmbedGroup";
    }
}
