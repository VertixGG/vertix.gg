...
import type {
    ...
    UIDefaultModalChannelTextInteraction, UIDefaultStringSelectMenuChannelTextInteraction,
...
export class SetupAdapter extends AdminAdapterBase<BaseGuildTextChannel, DefaultInteraction> {
    ...
    private async onSelectEditMasterChannel( interaction: UIDefaultStringSelectMenuChannelTextInteraction ) {
        ...
        const uiVersioningAdapterService = ServiceLocator.$.get<UIAdapterVersioningService>( "VertixGUI/UIVersioningAdapterService" ),
    ...
    private async onCreateMasterChannelClicked( interaction: UIDefaultButtonChannelTextInteraction, version: TVersionType = VERSION_UI_V2 ) {
        ...
        const adapterName = version === VERSION_UI_V3
            ? "Vertix/UI-V3/SetupNewWizardAdapter"
    ...
    private async onBadwordsModalSubmitted( interaction: UIDefaultModalChannelTextInteraction ) {
        const badwordsInputId = this.customIdStrategy
            .generateId( "VertixBot/UI-General/SetupAdapter:VertixBot/UI-General/BadwordsInput" );
