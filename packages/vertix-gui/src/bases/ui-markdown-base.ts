...
import type { UIArgs, UIBaseTemplateOptions, UIType } from "@vertix.gg/gui/src/bases/ui-definitions";

import type { UIMarkdownLanguageContent } from "@vertix.gg/gui/src/bases/ui-language-definitions";
...
export abstract class UIMarkdownBase extends UITemplateBase {
    ...
    public async build( uiArgs?: UIArgs ) {
        this.translatedContent = await this.uiService.getUILanguageManager()
