...
} from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/rename/dynamic-channel-meta-rename-modal";

import {
    DynamicChannelMetaRenameBadwordEmbed,
    DynamicChannelMetaRenameLimitedEmbed,
    DynamicChannelMetaRenameSuccessEmbed
} from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/rename/embeds";

export class DynamicChannelMetaRenameComponent extends UIComponentBase {
    public static getName() {
        return "Vertix/UI-V3/DynamicChannelMetaRenameComponent";
    }
