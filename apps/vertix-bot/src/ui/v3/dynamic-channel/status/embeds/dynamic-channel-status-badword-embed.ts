...
const DynamicChannelStatusBadwordEmbed = new EmbedBuilder<UIArgs, typeof vars>(
    "VertixBot/UI-V3/DynamicChannelStatusBadwordEmbed",
    vars
)
...
export { DynamicChannelStatusBadwordEmbed };
