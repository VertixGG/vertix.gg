...
const DynamicChannelMetaStatusSuccessEmbed = new EmbedBuilder<UIArgs, typeof vars>(
    "VertixBot/UI-V2/DynamicChannelMetaStatusSuccessEmbed",
    vars
)
...
export { DynamicChannelMetaStatusSuccessEmbed };
