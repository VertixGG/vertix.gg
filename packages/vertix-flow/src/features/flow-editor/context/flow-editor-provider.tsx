...
const FlowEditorContextInitializer: React.FC<FlowEditorContextInitializerProps> = ( {
    ...
    const setSidebarSelectedModule = useModuleSelectorStore( state => state.setSelectedModule );
    const setSidebarSelectedFlow = useModuleSelectorStore( state => state.setSelectedFlow );
