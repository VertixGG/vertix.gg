...
import { DynamicChannelLfmNoteInput } from "@vertix.gg/bot/src/ui/v2/dynamic-channel/lfm/dynamic-channel-lfm-note-input";

export class DynamicChannelLfmNoteModal extends UIModalBase {
    public static getName() {
        return "VertixBot/UI-V2/DynamicChannelLfmNoteModal";
    }
