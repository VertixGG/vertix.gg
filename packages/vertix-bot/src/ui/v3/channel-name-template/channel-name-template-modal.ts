...
import { ChannelNameTemplateInput } from "@vertix.gg/bot/src/ui/v3/channel-name-template/channel-name-template-input";

export class ChannelNameTemplateModal extends UIModalBase {
    public static getName() {
        return "Vertix/UI-V3/ChannelNameTemplateModal";
    }
