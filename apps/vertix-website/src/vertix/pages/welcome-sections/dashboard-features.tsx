export default function DashboardFeatures() {
    return (
        <div className="mb-12">
            <h2 id="dashboard-features" className="text-h4 mb-6">Dashboard</h2>
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 md:col-span-6">
                    <div className="p-4 bg-vc-space rounded border border-vc-hairline-bright h-full">
                        <h3 className="text-h5 text-vc-azure-soft mb-4">🎨 Visual Editor</h3>
                ...
                <div className="col-span-12 md:col-span-6">
                    <div className="p-4 bg-vc-space rounded border border-vc-hairline-bright h-full">
                        <h3 className="text-h5 text-vc-mint mb-4">⚙️ Bot Management</h3>
                        <ul className="text-vc-ice-dim text-sm mb-0 list-none pl-0">
            ...
            <div className="mt-6 text-center">
                <a href="https://dashboard.voicechannels.online" className="vc-btn vc-btn-azure" target="_blank" rel="noopener noreferrer">
                    Open Dashboard
                </a>
            </div>
        </div>
