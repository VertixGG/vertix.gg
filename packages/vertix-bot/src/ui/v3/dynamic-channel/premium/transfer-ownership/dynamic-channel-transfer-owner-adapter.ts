...
} from "@vertix.gg/bot/src/ui/v3/dynamic-channel/premium/transfer-ownership/dynamic-channel-transfer-owner-component";
import {
    DynamicChannelTransferOwnerButton
} from "@vertix.gg/bot/src/ui/v3/dynamic-channel/premium/transfer-ownership/dynamic-channel-transfer-owner-button";
...
export class DynamicChannelTransferOwnerAdapter extends DynamicChannelAdapterExuBase<DefaultInteraction> {
    ...
    protected static getExecutionSteps() {
        return {
            ...
            "Vertix/UI-V3/DynamicChannelTransferOwnerUserSelected": {
                ...
                elementsGroup: "Vertix/UI-V3/YesNoElementsGroup",
            },
            ...
            "Vertix/UI-V3/DynamicChannelTransferDisabledByClaim": {
                embedsGroup: "Vertix/UI-V3/DisabledWhileClaimEmbedGroup",
            },
    ...
    protected onEntityMap() {
        ...
        this.bindButton<UIDefaultButtonChannelVoiceInteraction>(
            "Vertix/UI-V3/YesButton",
            this.onYesButtonClicked
        );

        this.bindButton<UIDefaultButtonChannelVoiceInteraction>(
            "Vertix/UI-V3/NoButton",
