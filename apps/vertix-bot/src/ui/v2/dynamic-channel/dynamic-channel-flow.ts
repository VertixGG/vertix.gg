...
export class DynamicChannelFlow extends UIFlowBase<string, string, UIFlowDataBase> {
    ...
    public static getFlowTransitions(): Record<string, string[]> {
        return {
            "VertixBot/UI-V2/DynamicChannelFlow/States/Default": [
                ...
                "VertixBot/UI-V2/DynamicChannelFlow/Transitions/OpenStatus",
                ...
                "VertixBot/UI-V2/DynamicChannelFlow/Transitions/OpenLfm"
            ]
        };
    }
    ...
    public static override getEdgeSourceMappings(): UIFlowVisualConnection[] {
        return [
            ...
            {
                triggeringElementId: "VertixBot/UI-V2/DynamicChannelMetaStatusButton",
                transitionName: "VertixBot/UI-V2/DynamicChannelFlow/Transitions/OpenStatus",
                targetFlowName: "VertixBot/UI-V2/DynamicChannelMetaStatusFlow"
            },
            {
            ...
            {
                triggeringElementId: "VertixBot/UI-V2/DynamicChannelLfmButton",
                transitionName: "VertixBot/UI-V2/DynamicChannelFlow/Transitions/OpenLfm",
                targetFlowName: "VertixBot/UI-V2/DynamicChannelLfmFlow"
            }
        ];
    }
