...
// It shares the same buttons and behavior, so we don't define transactions here to avoid
// duplication in flow visualization. The flow is tracked through DynamicChannelAdapter.
