...
const DynamicChannelPermissionsDeniedEmbed = new EmbedBuilder<UIArgs, typeof vars>(
    ...
    .setDescription( () => (
        `**${ vars.userDeniedDisplayName }** successfully revoked and no longer has access to this channel!\n\n` +
