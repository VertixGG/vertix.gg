...
import { DynamicChannelMetaClearChatSuccessEmbed } from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/clear-chat/embeds/dynamic-channel-meta-clear-chat-success-embed";
import { DynamicChannelMetaClearChatNothingToClearEmbed } from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/clear-chat/embeds/dynamic-channel-meta-clear-chat-nothing-to-clear-embed";
...
export class DynamicChannelMetaClearChatComponent extends UIComponentBase {
    public static getName(): string {
        return "Vertix/UI-V3/DynamicChannelMetaClearChatComponent";
    }
