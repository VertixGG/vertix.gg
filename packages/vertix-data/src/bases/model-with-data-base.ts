...
import type { ModelDataOwnerBase, TDataOwnerDefaultUniqueKeys } from "@vertix.gg/data/src/bases/model-data-owner-base";
import type { TDataDefaultResult, TDataType } from "@vertix.gg/data/src/factory/data-type-factory";
