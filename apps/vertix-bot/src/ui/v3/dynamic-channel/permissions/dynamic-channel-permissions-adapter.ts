...
const DynamicChannelPermissionsAdapter = new DynamicExecutionAdapterBuilder<DefaultInteraction>(
    ...
    .defineTransactions( ( tx ) => {
        tx
            ...
            // the screen, and stay ephemeral - `UIAdapterBase.ephemeral()` sees a message with no
            // controls on it, files it in the notice slot, and a second refusal replaces the first.
            .addState( "Granted", {
