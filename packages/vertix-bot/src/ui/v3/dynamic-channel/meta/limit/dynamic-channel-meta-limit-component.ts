...
import { DynamicChannelMetaLimitSuccessEmbed } from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/limit/embeds/dynamic-channel-meta-limit-success-embed";
import { DynamicChannelMetaLimitInvalidInputEmbed } from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/limit/embeds/dynamic-channel-meta-limit-invalid-input-embed";

import { DynamicChannelMetaLimitModal } from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/limit/dynamic-channel-meta-limit-modal";
...
export class DynamicChannelMetaLimitComponent extends UIComponentBase {
    public static getName() {
        return "Vertix/UI-V3/DynamicChannelMetaLimitComponent";
    }
