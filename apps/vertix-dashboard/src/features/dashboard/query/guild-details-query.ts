...
import type { GuildDetails } from "@vertix.gg/dashboard/src/features/dashboard/types";
...
export class GuildDetailsQuery extends QueryModuleBase<GuildDetails> {
    ...
    public static getName(): string {
        return "dashboard/guild-details";
    }
    ...
    protected registerEndpoints(): void {
        this.defineEndpoint<GuildDetails, GuildDetails>( "Dashboard/GuildDetails", {
            method: "GET",
