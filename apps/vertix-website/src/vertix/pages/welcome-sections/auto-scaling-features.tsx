...
export default function AutoScalingFeatures() {
    return (
        <div className="mb-12">
            <h2 id="auto-scaling-features" className="text-h4 mb-6">Auto-Scaling Channels</h2>
            ...
            { /* How It Works */ }
            <div className="mb-6">
                <h3 className="text-h5 text-vc-cyan mb-4">How It Works</h3>
            ...
            <div className="grid grid-cols-12 gap-6 mt-2">
                <div className="col-span-12 md:col-span-6">
                    <div className="p-4 bg-vc-space rounded border border-vc-hairline-bright h-full">
                        <h3 className="text-h5 text-vc-azure-soft mb-4">Create</h3>
                ...
                <div className="col-span-12 md:col-span-6">
                    <div className="p-4 bg-vc-space rounded border border-vc-hairline-bright h-full">
                        <h3 className="text-h5 text-vc-mint mb-4">Configure</h3>
