...
} from "@vertix.gg/bot/src/ui/v3/dynamic-channel/meta/clear-chat/dynamic-channel-meta-clear-chat-component";
...
export class DynamicChannelMetaClearChatAdapter extends DynamicChannelAdapterBase {
    public static getName() {
        return "Vertix/UI-V3/DynamicChannelMetaClearChatAdapter";
    }
    ...
    private async onClearChatButtonClicked( interaction: UIDefaultButtonChannelVoiceInteraction ) {
        ...
        switch ( result?.code ) {
            case "success":
                ...
                this.getComponent().switchEmbedsGroup( "Vertix/UI-V3/DynamicChannelMetaClearChatSuccessEmbedGroup" );
            ...
            case "nothing-to-delete":
                this.getComponent().switchEmbedsGroup( "Vertix/UI-V3/DynamicChannelMetaClearChatNothingToClearEmbedGroup" );
                break;
