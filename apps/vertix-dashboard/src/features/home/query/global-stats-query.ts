...
import type { GlobalStats } from "@vertix.gg/dashboard/src/features/home/types";
...
export class GlobalStatsQuery extends QueryModuleBase<GlobalStats> {
    ...
    protected registerEndpoints(): void {
        this.defineEndpoint<GlobalStats, GlobalStats>( "Home/GlobalStats", {
            method: "GET",
