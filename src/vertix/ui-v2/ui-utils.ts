import { UI_ELEMENTS_DEFAULT_MAX_PER_ROW } from "@vertix/ui-v2/_base/ui-definitions";
...
export const uiUtilsDynamicElementsRearrange = ( elements: [][], elementsPerRow: number = UI_ELEMENTS_DEFAULT_MAX_PER_ROW ): [][] => {
