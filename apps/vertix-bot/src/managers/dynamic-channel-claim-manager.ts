...
export class DynamicChannelClaimManager extends InitializeBase {
    ...
    private async handleVoteRequestIdleState(
        ...
        // The only answer this path gives the click: the vote itself appears by editing the
        // message rather than by replying, so without this discord waits out its three seconds
        // and tells whoever pressed the button that the bot never responded.
