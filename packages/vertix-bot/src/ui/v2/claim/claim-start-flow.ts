...
export class ClaimStartFlow extends UIFlowBase<string, string, ClaimStartFlowData> {
    public static override getName(): string {
        return "VertixBot/UI-V2/ClaimStartFlow";
    }
    ...
    public static getFlowTransitions(): Record<string, string[]> {
        return {
            "VertixBot/UI-V2/ClaimStartFlow/States/Default": [
                "VertixBot/UI-V2/ClaimStartFlow/Transitions/RequestClaim"
            ]
        };
    }
    ...
    public static getNextStates(): Record<string, string> {
        return {
            "VertixBot/UI-V2/ClaimStartFlow/Transitions/RequestClaim": "VertixBot/UI-V2/ClaimStartFlow/States/Default"
        };
    }
    ...
    protected override getInitialState(): string {
        return "VertixBot/UI-V2/ClaimStartFlow/States/Default";
    }
