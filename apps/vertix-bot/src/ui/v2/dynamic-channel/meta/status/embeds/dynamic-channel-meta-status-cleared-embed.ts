...
const DynamicChannelMetaStatusClearedEmbed = new EmbedBuilder<UIArgs, typeof vars>(
    "VertixBot/UI-V2/DynamicChannelMetaStatusClearedEmbed",
    vars
)
...
export { DynamicChannelMetaStatusClearedEmbed };
