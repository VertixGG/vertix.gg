...
const DynamicChannelMetaStatusBadwordEmbed = new EmbedBuilder<UIArgs, typeof vars>(
    "VertixBot/UI-V2/DynamicChannelMetaStatusBadwordEmbed",
    vars
)
    .setInstanceType( UIInstancesTypes.Dynamic )
    .setColor( VERTIX_DEFAULT_COLOR_ORANGE_RED )
    .setTitle( () => "🙅  Failed to set your channel's status" )
...
export { DynamicChannelMetaStatusBadwordEmbed };
