 ...
 *
 * A scrolling list of checkboxes rather than a multi-select: a guild can carry dozens of roles,
 * and a native multiple-select hides all but a few of them behind a drag.
 */
                    ...
                    { roles.map( ( role ) => (
                        ...
                        >
                            ...
                            <span
                                ...
                                style={ { background: role.color ? `#${ role.color.toString( 16 ).padStart( 6, "0" ) }` : "var(--color-text-muted)" } }
                            />
                            <span className="text-text-primary truncate">{ role.name }</span>
                        </label>
                    ) ) }
                </div>
            ) : (
